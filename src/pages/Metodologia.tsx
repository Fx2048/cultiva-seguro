        ...
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-extrabold">📐 {t("metodo.title")}</h1>
                <p className="text-xs font-semibold opacity-80">{t("metodo.subtitle")}</p>
              </div>
            </div>
            <LanguageToggle />
          </div>
      ...
      <main className="max-w-lg mx-auto px-4 mt-6 space-y-5">
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">❄️ {t("metodo.frost_model")}</h2>
          </div>
          <div className="space-y-3 text-sm text-muted-foreground">
            <div className="p-3 rounded-xl bg-frost/5 border border-frost/20">
              <p className="font-bold text-foreground mb-1">{t("metodo.main_formula")}</p>
            ...
            <div>
              <p className="font-bold text-foreground mb-2">{t("metodo.aggravating")}</p>
              <ul className="space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="text-danger font-bold text-xs mt-0.5">+25%</span>
                  <span className="text-xs"><strong>{t("metodo.duration")}</strong> ≥2 días consecutivos bajo umbral de cultivo</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-danger font-bold text-xs mt-0.5">+20%</span>
                  <span className="text-xs"><strong>{t("metodo.sensitive_stage")}</strong> Floración (máxima vulnerabilidad)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-warning font-bold text-xs mt-0.5">+15%</span>
                  <span className="text-xs"><strong>{t("metodo.low_soil_moisture")}</strong> Precipitación &lt;20mm (suelo seco = más vulnerable)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-warning font-bold text-xs mt-0.5">+10%</span>
                  <span className="text-xs"><strong>{t("metodo.weak_vegetation")}</strong> NDVI &lt;0.25 (cultivo estresado)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">🌱 {t("metodo.crop_thresholds")}</h2>
          </div>
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-center py-2 font-extrabold text-foreground">{t("metodo.flowering")}</th>
                  <th className="text-center py-2 font-extrabold text-foreground">{t("metodo.vegetative")}</th>
                  <th className="text-center py-2 font-extrabold text-foreground">{t("metodo.tuberization")}</th>
                </tr>
              </thead>
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">🌵 {t("metodo.drought_model")}</h2>
          </div>
          <div className="space-y-3 text-sm text-muted-foreground">
            <div className="p-3 rounded-xl bg-drought/5 border border-drought/20">
              <p className="font-bold text-foreground mb-1">{t("metodo.formula")}</p>
              <p className="font-mono text-xs bg-muted p-2 rounded-lg">
                SPI = (P_mes − μ_global) / σ_global
              </p>
            </div>
            <div>
              <p className="font-bold text-foreground mb-2">{t("metodo.classification")}</p>
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">🛰️ {t("metodo.data_sources")}</h2>
          </div>
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">📈 {t("metodo.precision")}</h2>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 rounded-xl bg-frost/10 border border-frost/20 text-center">
              <p className="text-xs font-bold text-muted-foreground mb-1">❄️ {t("alert.frost")}</p>
              <p className="text-lg font-extrabold text-frost">78.3%</p>
              <p className="text-[10px] text-muted-foreground">{t("metodo.precision_label")}</p>
              <p className="text-lg font-extrabold text-frost mt-1">90.0%</p>
              <p className="text-[10px] text-muted-foreground">{t("metodo.recall_label")}</p>
            </div>
            <div className="p-3 rounded-xl bg-drought/10 border border-drought/20 text-center">
              <p className="text-xs font-bold text-muted-foreground mb-1">🌵 {t("alert.drought")}</p>
          ...
          <div className="mt-3 p-3 rounded-xl bg-muted/50">
            <p className="text-xs font-bold text-foreground">🔍 {t("metodo.what_means")}</p>
          </div>
        </section>
        ...
        <section className="rounded-2xl border-2 border-border bg-card p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-extrabold text-foreground">⚠️ {t("metodo.limitations")}</h2>
          </div>
        </section>
        ...
        <section className="rounded-2xl border-2 border-safe bg-safe/10 p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-base font-extrabold text-foreground">💡 {t("metodo.recommendation")}</h2>
          </div>
          <p className="text-sm text-muted-foreground">{t("metodo.recommendation_text")}</p>
          <div className="mt-3 p-3 rounded-xl bg-card border border-border">
            <p className="text-xs font-bold text-foreground">{t("metodo.confidence_levels")}</p>
            <div className="flex items-center gap-3 mt-1">
              <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-safe/20 text-safe border border-safe">{t("confidence.high")}</span>
              <span className="text-[10px] text-muted-foreground">0-3 meses</span>
            </div>
            <div className="flex items-center gap-3 mt-1">
              <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-warning/20 text-warning border border-warning">{t("confidence.medium")}</span>
              <span className="text-[10px] text-muted-foreground">3-6 meses</span>
            </div>
            <div className="flex items-center gap-3 mt-1">
              <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-danger/20 text-danger border border-danger">{t("confidence.low")}</span>
              <span className="text-[10px] text-muted-foreground">6-10 meses</span>
            </div>
          </div>
        </section>
      </main>
